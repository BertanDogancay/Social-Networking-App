...
import 'package:private_chat_app/features/chat/widgets/sender_message_card.dart';
import 'package:private_chat_app/models/message_model.dart';
import 'package:private_chat_app/features/chat/widgets/my_message_card.dart';
...
class _ChatListState extends ConsumerState<ChatList> {
  ...
  void onMessageSwipe(
      String message, String senderName, bool isMe, MessageEnum messageEnum) {
    ref.read(messageReplyProvider.state).update((state) =>
        MessageReplyProvider(message, senderName, isMe, messageEnum));
  }
              ...
              itemBuilder: (context, index) {
                ...
                if (messageData.senderId ==
                  ...
                  return MyMessageCard(
                      ...
                      onLeftSwipe: () => onMessageSwipe(messageData.text,
                          messageData.senderName, true, messageData.type),
                ...
                return SenderMessageCard(
                  ...
                  repliedMessageType: messageData.repliedMessageType,
                  onRightSwipe: () => onMessageSwipe(messageData.text,
                      messageData.senderName, false, messageData.type),
                  repliedText: messageData.repliedMessage,
