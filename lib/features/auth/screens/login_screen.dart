...
import 'package:private_chat_app/common/widgets/custom_button.dart';
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('Private Chat will need to verify your phone number.'),
              const SizedBox(height: 10),
              TextButton(
                  onPressed: pickCountry, child: const Text('Select Country', style: TextStyle(
